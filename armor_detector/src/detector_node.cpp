  ...
  if (pnp_solver_ != nullptr) {
    ...
    for (const auto & armor : armors) {
      ...
      if (success) {
        ...
        double yaw_a = asin( (rotation_matrix.at<double>(0,0)+tvec.at<double>(0)) /
                        sqrt( (rotation_matrix.at<double>(0,0)+tvec.at<double>(0)) * (rotation_matrix.at<double>(0,0)+tvec.at<double>(0)) +
                              (rotation_matrix.at<double>(0,2)+tvec.at<double>(2)) * (rotation_matrix.at<double>(0,2)+tvec.at<double>(2))));

        armor_msg.yaw_r = yaw_a;
